...
class test_get_lang_list(unittest.TestCase):
    ...
    def test_get_multiple_list(self):
        url = 'https://youtu.be/QImCld9YubE'
        tobe = ['gl', 'el', 'nl', 'nl-NL', 'no', 'de', 'la', 'ru', 'ro', 'ml', 'ms', 'mn', 'vi', 'sr', 'sv', 'es',
                'es-US', 'sl', 'ar', 'az', 'af', 'et', 'en', 'uk', 'it', 'id', 'ja', 'jv', 'zh', 'zh-Hans', 'zh-TW',
                'zh-HK', 'cs', 'th', 'tr', 'tk', 'fa', 'pt', 'pt-BR', 'pl', 'fr', 'fr-CA', 'fi', 'fil', 'ko', 'hu',
                'iw', 'hi']
